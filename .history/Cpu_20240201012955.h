...
public:
    ...
    void getInstrumentationData(unsigned int &cyclesExecuted,
...
private:
    ...
    // Add private member variables to track instrumentation data
    unsigned int totalCyclesExecuted;
    unsigned int totalMemoryAccessCycles;
    unsigned int totalWriteBackCycles;
};
